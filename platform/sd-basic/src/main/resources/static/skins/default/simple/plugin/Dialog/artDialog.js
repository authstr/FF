...
(function(e, t) {
	...
	v.fn = v.prototype = {
		...
		position: function(e, t) {
			...
			if(r.config.title==false){
				...
				if (t || t === 0) r._top = t.toString().indexOf("%") !== -1 ? t : null, t = r._toNumber(t, m - y), typeof t == "number" ? (t = u ? t += c : t + d, b.top = Math.max(t+40, d) + "px") : typeof t == "string" && (b.top = t);
			}
		...
		zIndex: function() {
			var e = this,
				...
				r = v.focus,
				i = v.defaults.zIndex++;
			if(e.config.className!=null){
				n.addClass(e.config.className);
			}
			if(e.config.warning!=null){
				n.addClass("g-warning-dialog");
			}
	...
	v._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:/*artDialog*/;"></a><a class="hide intro J_arrowAction" href="javascript:/*artDialog*/;">功能介绍<i class="gi-down"></i></a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>', v.defaults = {
